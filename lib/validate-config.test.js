...
it('returns errors in an array for invalid config 1', () => {
  expect(validateConfig(badValidation1)).toEqual([
    ...
    new Error('config item value must be defined for key "valueUndefined"'),
    ...
    new Error('value property must be set for items inside values for key "valuesWithEmptyValue"'),
